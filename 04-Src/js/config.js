...
var settings={particles:true,bubbles:true,currents:true,vignette:true,healthBars:true,shadows:true,density:1.0,lightMul:1.0,virusRate:0.7,renderMode:'cartoon',microscopeMode:false};
