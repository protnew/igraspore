...
- Name: extended_test.js >> iGraSpore V2 — Extended Functional Tests >> E2: Stomach contents visible after eating
- Location: 07-QA-and-Testing\playwright\extended_test.js:36:3
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]:
    ...
    - generic:
      ...
      - generic: Gen 0 · -1.1μm
      - generic:
        - text: "Энергия: 101/100 · Возраст: 6s"
    ...
    - generic:
      ...
      - generic: macrophage
  - generic:
    - generic: "Поп-ция: 2289"
    - generic: "FPS: 24 · Свет: 28%"
